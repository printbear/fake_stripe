!(function(e) {
  ...
  function(e, t, n) {
    ...
    var _e,
      ...
      qe = Object.keys(Le),
      De = { live: "live", test: "test", unknown: "unknown" },
      xe = function(e) {
      ...
      Qe = function(e) {
        return function(t, n) {
          return "string" == typeof t && 0 === t.indexOf(e)
            ? ze(t)
            : We("a string starting with " + e, t, n);
        };
      },
      $e = function() {
      ...
      tt =
        ($e.apply(void 0, s(Object.keys(De))),
        function(e, t) {
      ...
      it = function(e) {
        return function(t, n) {
          return "number" == typeof t && t > e
            ? ze(t)
            : We("a number greater than " + e, t, n);
        };
      },
      at = function(e) {
        return function(t, n) {
      ...
      ut = function(e, t) {
        return e && "object" === (void 0 === e ? "undefined" : Ue(e))
          ? ze(e)
          : We("an object", e, t);
      },
      lt = function(e) {
          ...
          if (Array.isArray(t)) {
            return t
              .map(function(t, r) {
                return e(
                  t,
                  Be({}, n, { path: [].concat(s(n.path), [String(r)]) })
                );
              })
              .reduce(function(e, t) {
                return "error" === e.type
            ...
            if (Array.isArray(n)) {
              ...
              if ("valid" === o.type)
                for (var i = {}, a = 0; a < o.value.length; a += 1) {
                  var s = o.value[a];
                  if (
                    "object" === (void 0 === s ? "undefined" : Ue(s)) &&
                    s &&
                    "string" == typeof s[e]
                  ) {
                    var c = s[e];
            ...
            if (
              ...
              return (
                ...
                Object.keys(t).reduce(function(e, n) {
                  ...
                  var i = t[n],
                    c = i(o[n], Be({}, r, { path: [].concat(s(r.path), [n]) }));
                  return "valid" === c.type && void 0 !== c.value
                    ? ze(
                        Be({}, e.value, a({}, n, c.value)),
                        [].concat(s(e.warnings), s(c.warnings))
                      )
                    : "valid" === c.type
                    ? ze(e.value, [].concat(s(e.warnings), s(c.warnings)))
                    : c;
                }, u)
              );
            }
      ...
      Ot = Object({
        ...
        SELENIUM_TEST_ENV: !1,
        PUBLIC_URL: "",
        RELEASE_VERSION: "c2c3e123",
        STRIPE_JS_API_URL: "https://localhost:12112", // "https://api.stripe.com/v1/",
        STRIPE_JS_HOOKS_URL: "https://localhost:12112",
        STRIPE_JS_ALLOW_MUTABLE_API_URL: !1,
        STRIPE_JS_Q_URL: "https://localhost:12112",
        STRIPE_JS_ROOT_URL: "https://localhost:12112",
        STRIPE_CHECKOUT_URL: "https://localhost:12112",
        STRIPE_JS_SOURCEMAPS: !1,
        STRIPE_JS_DEBUG_POSTMESSAGE: !1,
        STRIPE_JS_DEBUG_LOGGER: !0,
        CARDINAL_INNER_HTML_NAME:
          "cardinal-inner-bd6845376a818e07081b410afe0f5d15.html",
        THREE_DS_2_FINGERPRINT_HTML_NAME:
          "three-ds-2-fingerprint-d94afdfa9fb30c1468eac192cada54df.html",
        THREE_DS_2_CHALLENGE_HTML_NAME:
          "three-ds-2-challenge-52baea0514ce962a8d10c8c9e4bcc059.html",
        AUTHORIZE_WITH_URL_INNER_HTML_NAME:
          "authorize-with-url-inner-dedfed415ea5c215a519bea9a85efbee.html",
        PAYMENT_REQUEST_INNER_GOOGLE_PAY_HTML_NAME:
          "payment-request-inner-google-pay-9eb56a1f32f4e80ffa764b6f32f4993f.html",
        PAYMENT_REQUEST_INNER_BROWSER_HTML_NAME:
          "payment-request-inner-browser-4f33ec66659f9e9bb1d94323f6c35ef4.html",
        CONTROLLER_HTML_NAME:
          "controller-5fe6e88b2b202ea46200d8e6538a3fe7.html",
        ...
        ELEMENTS_INNER_AU_BANK_ACCOUNT_HTML_NAME:
          "elements-inner-au-bank-account-37a653c07b9ce8aa57aa94d1d07eccdb.html",
        ELEMENTS_INNER_PAYMENT_REQUEST_HTML_NAME:
          "elements-inner-payment-request-458caee359bdcef361254df2f31d0c75.html",
        ELEMENTS_INNER_IDEAL_BANK_HTML_NAME:
          "elements-inner-ideal-bank-254f984e3c97b7efccb2945e48c104ae.html",
        ELEMENTS_INNER_IBAN_HTML_NAME:
          "elements-inner-iban-95593cdcab4230b50c1f373f584fb7da.html",
        ELEMENTS_INNER_CARD_HTML_NAME:
          "elements-inner-card-46d77db1cd45855c90556b0f3c7fdd99.html",
      ...
      Rt = It,
      Nt = { PAYMENT_INTENT: "PAYMENT_INTENT", SETUP_INTENT: "SETUP_INTENT" },
      Ct = Nt,
      ...
      Ln = jn({}, Mn, { background: "rgba(0,0,0,0.5)" }),
      qn = function e(t) {
        var n = this,
          r = t.lockScrolling,
          o = t.lockFocus,
            ...
            },
            {
              ...
              value: function(e) {
                var n = Yn(
                  ...
                  "_createIFrame",
                  this
                ).call(this, Hn({}, e, { isSecondaryFrame: !0 }));
      ...
      fr =
        ...
        (function(e) {
          return (
            /AppleWebKit/i.test(e) && !/Chrome/i.test(e) && !tr(e) && !nr(e)
          );
        })(ar)),
      hr = (function(e) {
      ...
      _r =
        ...
        R(_e, Rt.cardNumber, { unique: !0, conflict: [Rt.card], beta: !1 }),
        R(_e, Rt.cardExpiry, { unique: !0, conflict: [Rt.card], beta: !1 }),
        R(_e, Rt.cardCvc, { unique: !0, conflict: [Rt.card], beta: !1 }),
        R(_e, Rt.postalCode, { unique: !0, conflict: [Rt.card], beta: !1 }),
        R(_e, Rt.paymentRequestButton, { unique: !0, conflict: [], beta: !1 }),
        R(_e, Rt.iban, { unique: !0, conflict: [], beta: !1 }),
        R(_e, Rt.idealBank, { unique: !0, conflict: [], beta: !1 }),
        R(_e, Rt.auBankAccount, { unique: !0, beta: !0, conflict: [] }),
        R(_e, Rt.fpxBank, { unique: !0, beta: !0, conflict: [] }),
        _e),
      mr = _r,
      yr =
        ((me = {}),
        N(me, Rt.card, kt.CARD_ELEMENT),
        ...
        N(me, Rt.paymentRequestButton, kt.PAYMENT_REQUEST_ELEMENT),
        N(me, Rt.iban, kt.IBAN_ELEMENT),
        N(me, Rt.idealBank, kt.IDEAL_BANK_ELEMENT),
        N(me, Rt.auBankAccount, kt.AU_BANK_ACCOUNT_ELEMENT),
        N(me, Rt.fpxBank, kt.FPX_BANK_ELEMENT),
        me),
      vr = yr,
      br = ["brand"],
      gr = ["country", "bankName"],
      ...
      wr =
        ((ye = {}),
        C(ye, Rt.card, br),
        C(ye, Rt.cardNumber, br),
        C(ye, Rt.iban, gr),
        C(ye, Rt.auBankAccount, Er),
        ye),
      Sr =
        ((ve = {}),
        C(ve, Rt.idealBank, { secondary: Rt.idealBankSecondary }),
        C(ve, Rt.fpxBank, { secondary: Rt.fpxBankSecondary }),
        ve),
      kr =
        Object.assign ||
        function(e) {
      ...
      Tr = function(e) {
        return "object" === (void 0 === e ? "undefined" : Or(e)) &&
          null !== e &&
          "IntegrationError" === e.name
          ? new Se("string" == typeof e.message ? e.message : "")
          : e;
      },
      Ir = function e(t) {
        ...
        (this._id = Ut("__privateStripeController")),
          ...
          (this._controllerFrame = new wn(kt.CONTROLLER, this._id, kr({}, t))),
          (this._frames = {}),
          (this._requests = {}),
          this._setupPostMessage(),
          (this._handleMessage = on(this._handleMessage, this)),
      ...
      Rr = function() {
        ...
        (this._sendCAReq = function(t) {
          ...
          (this.createElementFrame = function(t, n) {
            var r = n.groupId,
              o = j(n, ["groupId"]),
              i = new An(t, e._id, kr({}, o, { keyMode: xe(e._apiKey) }));
            ...
            if (n === e._id)
              switch (o.action) {
                ...
                case "stripe-safe-controller-action-error":
                  e._requests[o.payload.nonce] &&
                    e._requests[o.payload.nonce].reject(Tr(o.payload.caErr));
              }
          });
      },
      Nr = Ir,
        ...
        return new Te(function(n, r) {
          var o = t.method,
            ...
            u =
              ...
              (Et(i) && void 0 === new XMLHttpRequest().withCredentials),
            l = "GET" === o && c ? i + "?" + c : i,
            p = "GET" === o ? "" : c;
          if (u) {
              ...
              (f.onreadystatechange = function() {
                4 === f.readyState &&
                  ...
                  0 === f.status
                    ? s
                      ? r(new xr())
                      : e(Fr({}, t, { withCredentials: !0 })).then(n, r)
                    : n(f));
              });
            try {
              f.send(p);
      ...
      Jr = function(e, t) {
        ...
        return (
          ["family", "src"].forEach(function(e) {
            if (!n[e])
              throw new Se(
                "Missing css property in file from " + t + ': "' + Dt[e] + '"'
              );
          }),
          n
        );
      ...
      ro = { shipping: "shipping", delivery: "delivery", pickup: "pickup" },
      oo = eo({ success: "success" }, no),
      io = { merchantCapabilities: ["supports3DS"], displayItems: [] },
      ao = _t({ amount: ct, label: tt, pending: Ke(rt) }),
      so = _t({ amount: st, label: tt, pending: Ke(rt) }),
      co = _t({
        amount: st,
        label: tt,
        pending: Ke(rt),
      ...
      ho = function(e, t) {
        ...
        return $e.apply(void 0, F(Object.keys(to)))(
      ...
      Eo = function(e) {
        return (
          e &&
          "object" === (void 0 === e ? "undefined" : go(e)) &&
            ...
            r.forEach(function(n) {
              n &&
                Object.keys(n).forEach(function(r) {
                  ...
                  "object" === (void 0 === a ? "undefined" : go(a)) && s
                    ? (i[r] = e(t)(o, wo(a)))
                    : void 0 !== a
                    ? (i[r] = Eo(a) ? e(t)(a) : wo(a))
                    : void 0 !== o && (i[r] = o);
      ...
      To = function(e, t, n, r) {
        var o =
            arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : Po,
          i = Math.max(Po, o);
      ...
      Bo =
        ...
        U(be, oo.success, 0),
        U(be, oo.fail, 1),
        U(be, oo.invalid_payer_name, 2),
        U(be, oo.invalid_shipping_address, 3),
        U(be, oo.invalid_payer_phone, 4),
        U(be, oo.invalid_payer_email, 4),
        be),
      Uo =
        ((ge = {}),
        U(ge, ro.pickup, "storePickup"),
        U(ge, ro.shipping, "shipping"),
        U(ge, ro.delivery, "delivery"),
        ge),
      Ho = {
        total: function(e) {
          return Do(e.total, e);
      ...
      si = function(e, t) {
        return e && "object" === (void 0 === e ? "undefined" : ii(e))
          ? t(e)
          : null;
      },
      ci = (function() {
        function e(t) {
          ...
          z(this, e),
            ...
            (this.canMakePayment = function() {
              return To(
                ...
                xe(n._authentication.apiKey) === De.test,
                n._report,
                n._minimumVersion
              );
            }),
            (this.update = function(e) {
              (n._initialPaymentRequest = ko(n._paymentRequestOptions, e)),
            ...
            (this._onToken = function(e) {
              return function(t) {
                n._onEvent({
                  ...
                  payload: ri({}, t, { complete: n._completePayment(e) })
                });
              };
            }),
          ...
          (this._controller = r),
            ...
            (this._mids = i),
            (this._minimumVersion = a.__minApplePayVersion || Po),
          ...
          oi(e, [
            {
              ...
              value: function() {
                (this._paymentRequestOptions = ri(
                  {},
                  io,
            ...
            },
            {
              ...
              value: function(e, t) {
                ...
                e.addEventListener(
                  "validatemerchant",
                  on(this._validateMerchant(e, t))
                ),
                  e.addEventListener(
                    "paymentauthorized",
                    on(this._paymentAuthorized(e))
                  ),
                  e.addEventListener(
                    "cancel",
                    on(function() {
                  ...
                  e.addEventListener(
                    ...
                    on(this._shippingContactSelected(e))
                  ),
                  e.addEventListener(
                    "shippingmethodselected",
                    on(this._shippingMethodSelected(e))
                  );
              }
            }
          ]),
      ...
      wi = function e(t) {
        ...
        if (
          ...
          vi && "https:" === window.location.protocol)
        ) {
          this._controller.action.fetchLocale({ locale: "auto" });
          var s = this._controller.createHiddenFrame(
            kt.PAYMENT_REQUEST_BROWSER,
      ...
      Si = function() {
        ...
        (this._onEvent = function() {}),
          ...
          (this.show = function() {
            if (!e._prFrame)
              throw new Se("Payment Request is not available in this browser.");
            e._prFrame.send({
              action: "stripe-pr-show",
      ...
      Pi = (function(e) {
        function t(e) {
          ...
          return (
            (n._queryStrategy = e.queryStrategyOverride || vo(e.betas)),
        ...
        (this._usedByButtonElement = null),
          ...
          (this._initBackingLibraries = function(t) {
            e._queryStrategy.forEach(function(n) {
              ...
              switch (n) {
                case "APPLE_PAY":
                  (e._backingLibraries.APPLE_PAY = new ui(r)),
                    e._backingLibraries.APPLE_PAY.setEventHandler(
                      e._handleInternalEvent
                    );
                  break;
                case "GOOGLE_PAY":
                  (e._backingLibraries.GOOGLE_PAY = new yi(r)),
                    e._backingLibraries.GOOGLE_PAY.setEventHandler(
                      e._handleInternalEvent
                    );
                  break;
                case "BROWSER":
                  (e._backingLibraries.BROWSER = new ki(r)),
                ...
                e._controller.action
                  ...
                  .then(function(t) {
                    "error" === t.type
                      ...
                      : e._maybeEmitPaymentResponse({
                          type: "paymentmethod",
                          payload: Oi({}, i, { paymentMethod: t.object })
                        });
                  });
          }),
          (this._canMakePaymentForBackingLibrary = function(t) {
            ...
            return Te.race([
              ...
              return (
                (e._canMakePaymentAvailability = Oi(
                  {},
          ...
          (this.canMakePayment = on(function() {
            ...
            if ("https:" !== window.location.protocol)
              return (e._canMakePaymentResolved = !0), Te.resolve(null);
          ...
          (this.show = on(function() {
            ...
            if (!e._activeBackingLibrary)
              ...
              new Se("Payment Request is not available in this browser."));
      ...
      Ri = {
        ...
        error: Ke(
          _t({ type: tt, code: Ke(tt), decline_code: Ke(tt), param: Ke(tt) })
        ),
        locale: dt("elements()"),
        fonts: dt("elements()"),
        placeholder: Ke(tt),
      ...
      Ci = function(e, t, n) {
        var r =
          ("auBankAccount" === e && !qr(n, "au_bank_account_beta_1")) ||
          ("fpxBank" === e && !qr(n, "fpx_bank_beta_1"));
        if (!e || !(e in mr) || r)
          throw new Se(
        ...
        if (mr[e].unique && -1 !== t.indexOf(e))
          throw new Se("Can only create one Element of type " + e + ".");
        var o = mr[e].conflict,
          i = Ne(t, o);
        if (i.length) {
          var a = i[0];
      ...
      Li = function() {
        var e =
            arguments.length > 0 && void 0 !== arguments[0]
              ...
              : "1.2em",
          t =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ji,
          n =
          ...
          Bi(t, [
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return (
                  ...
                  (this._classes = Fi({}, this._classes, t)),
                  this
                );
              }
            },
            {
              ...
              value: function(e, t) {
                return this._emit(
                  e,
                  Fi({ elementType: this._componentName }, t)
                );
              }
            },
            {
      ...
      Xi = function e(t, n) {
        ...
        return (
          ...
          (this._commonOptions = Ji({}, i, { fonts: c })),
              ...
              $r(e)
                .then(function(n) {
                  ...
                  var o = n.map(function(t) {
                    return Ji({}, t, { __resolveFontRelativeTo: e });
                  });
      ...
      Zi = function() {
        ...
        this.create = an(function(t, n) {
          ...
          return (
            (e._elements = [].concat(re(e._elements), [t])),
      ...
      ia = function(e, t) {
        switch (e.type) {
          ...
          case "error":
            return { error: oa({}, t ? { payment_intent: t } : {}, e.error) };
          default:
            return ke(e);
        }
      },
      ...
      ca = function(e, t) {
        ...
        var n = aa(e);
        return null === n
          ? We("a client secret of the form ${id}_secret_${secret}", e, t)
          : ze(n, []);
      },
      ua = function(e, t) {
        ...
        var n = e.type,
          r = ie(e, ["type"]),
          o = oa({}, t, { path: [].concat(oe(t.path), ["type"]) }),
          i = nt(tt, function() {
            return null;
          })(n, o);
        return "error" === i.type ? i : ze({ type: i.value, data: r });
      },
      la = function(e) {
      ...
      da = function(e, t) {
        ...
        if ("object" !== (void 0 === e ? "undefined" : ra(e)))
          return Ge("object", void 0 === e ? "undefined" : ra(e), t);
        var n = e.client_secret,
          r = e.status,
          o = e.next_action,
          i = oa({}, t, { path: [].concat(oe(t.path), ["client_secret"]) }),
          a = ca(n, i);
        if ("error" === a.type) return a;
        if ("string" != typeof r) {
          var s = oa({}, t, { path: [].concat(oe(t.path), ["status"]) });
          return Ge("string", void 0 === r ? "undefined" : ra(r), s);
        }
        if (
          ("requires_source_action" === r || "requires_action" === r) &&
          "object" !== (void 0 === o ? "undefined" : ra(o))
        ) {
          var c = oa({}, t, { path: [].concat(oe(t.path), ["next_action"]) });
        ...
        return function(t, n) {
          if ("object" === (void 0 === t ? "undefined" : ra(t)) && null !== t) {
            ...
            if (null != r && "string" != typeof r) {
              var c = oa({}, n, { path: [].concat(oe(n.path), ["source"]) });
            ...
            if (
              null != a &&
              "object" !== (void 0 === a ? "undefined" : ra(a))
            ) {
              var p = oa({}, n, {
            ...
            var d = oa({}, n, { path: [].concat(oe(n.path), ["source_data"]) }),
              f = ua(o, d);
          ...
          return null === t
            ? Ge("object", "null", n)
            : Ge("object", void 0 === t ? "undefined" : ra(t), n);
        };
      },
      ha = function(e) {
        return function(t, n) {
          ...
          if ("object" !== (void 0 === t ? "undefined" : ra(t)))
            return Ge("object", void 0 === t ? "undefined" : ra(t), n);
      ...
      ma =
        ((Ee = {}),
        ae(Ee, Rt.card, _a.card),
        ae(Ee, Rt.cardNumber, _a.card),
        ae(Ee, Rt.cardExpiry, _a.card),
        ae(Ee, Rt.cardCvc, _a.card),
        ae(Ee, Rt.postalCode, _a.card),
        ae(Ee, Rt.iban, _a.sepa_debit),
        ae(Ee, Rt.idealBank, _a.ideal),
        Ee),
      ya = function(e) {
      ...
      Sa = { MERCHANT: "merchant", SESSION: "session" },
      ka = (function() {
        function e() {
          var t = this,
            n =
          ...
          if ((se(this, e), n.checkoutIds)) {
            ...
            (this._muid = this._getID(Sa.MERCHANT)),
              (this._sid = this._getID(Sa.SESSION)),
              (this._doNotPersist = !1);
          (this._id = Ut(wa)),
            (this._controllerFrame = new wn(kt.METRICS_CONTROLLER, this._id, {
              autoload: !0,
      ...
      Oa = ka,
      Pa = { _frame: _t({ id: tt }), _componentName: tt },
      Aa = _t(Pa),
      Ta = function(e) {
        var t = mt(Aa, e, "");
      ...
      Ra = function(e, t, n, r, o, i) {
        ...
        var s = a.value,
          ...
          h = u.otherParams;
        if (!e && l)
          throw new Se(r + ": Expected payment_method_data, not source_data.");
        if (null != p)
          throw new Se(
            "When calling " +
              r +
          ...
          switch (r.type) {
            ...
            case "stripe_3ds2_fingerprint":
              return {
                ...
                cardBrand: Ma(r.directory_server_name),
                transactionId: r.server_transaction_id,
                optimizations: ja(r.three_ds_optimizations, n),
            ...
            case "stripe_3ds2_challenge":
              return {
                ...
                cardBrand: Ma(r.stripe_js.directory_server_name),
                transactionId: r.stripe_js.server_transaction_id,
                optimizations: ja(r.stripe_js.three_ds_optimizations, n),
        ...
        return (
          ...
          new Te(function(e, i) {
            s._once("authorize_with_url_done", function(i) {
              ...
              var u = function() {
                return Te.all([Da(t, n, r, o), s.destroy()]).then(function(e) {
                  return xa(e, 1)[0];
                });
              };
              "fallback" === i.type
                ? u().then(e)
                : i.result.error && !c(i.result.error)
                ? u().then(e)
      ...
      Wa = function(e, t, n, r) {
        return t.optimizations.skipFingerprint
          ? Te.resolve({ fingerprintAttempted: !1, fingerprintData: null })
          : "" === t.methodUrl
      ...
      Ka = function(e, t, n, r, o, i) {
        var a = Date.now(),
          s = Ga(e.id, r, n.cardBrand, i),
          c = function(e) {
            return s.then(function(t) {
              i || (t.show(), t.fadeInBackdrop());
              var n = (e.type, e.optimizations),
                r = ce(e, ["type", "optimizations"]);
              return t.action.perform3DS2Challenge(
                Ha({}, r, { shouldSandbox: n.sandboxChallengeFrame })
              );
            });
          },
          u = function(t) {
      ...
      Qa = function(e, t, n) {
        return Va(t).then(function(t) {
          return Ja(n, "ideal redirect", t), ia(t, e);
        });
      },
      $a = function(e, t, n) {
      ...
      es = function(e) {
        if (!e || "object" !== (void 0 === e ? "undefined" : Za(e)))
          return null;
        var t = e.type,
          n = ue(e, ["type"]);
      ...
      ns = {
        source: _t({ id: Qe("src_"), client_secret: Qe("src_client_secret_") })
      },
      rs = _t(ns),
      os = function(e) {
        switch (e.type) {
      ...
      cs = function(e, t, n, r, o) {
        var i = La(pa(t), n, e),
          a = sa(t);
        if (!i) return Te.resolve({ paymentIntent: t });
        switch (i.type) {
          case "3ds1-modal":
            return Ba(i.url, a, Ct.PAYMENT_INTENT, e, r);
          case "3ds2-fingerprint":
          case "3ds2-challenge":
            return Ka(a, Ct.PAYMENT_INTENT, i, e, r, o);
          ...
          case "ideal-redirect":
            return Qa(t, i.redirectUrl, e);
          default:
            return Te.resolve({ paymentIntent: t });
        }
      },
      us = function(e, t, n, r, o) {
        return cs(e, t, n, r, o).then(function(e) {
          if (e.setupIntent)
          ...
          switch (i.type) {
            case "error":
              ...
              return n &&
                ...
                ? Te.resolve({ paymentIntent: s })
                : Te.resolve(ia(o));
            case "object":
              var c = i.object;
              return us(e, c, t, i.locale, r);
            default:
              return ke(i);
          }
        };
      ...
      fs = function(e, t, n, r, o, i) {
        var a = yt(ca, r, "stripe.confirmPaymentIntent intent secret"),
          s = a.value,
          c = Ca(e, !1, null, "confirmPaymentIntent")(o, i);
        return t.action
          .confirmPaymentIntent(
            is({}, c, { intentSecret: s, expectedType: null, mids: n })
          )
          .then(ia);
      },
      hs = function(e, t) {
        var n = yt(
            ca,
            e,
            "[internal] stripe.handleHosted3DS2Setup intent secret"
          ),
          r = n.value;
        return t.action
          .retrievePaymentIntent({ intentSecret: r, hosted: !0 })
          .then(ls(t, _a.card, !1, !0));
      },
      _s = function(e, t) {
            ...
            switch (n.type) {
              ...
              case "object":
                ...
                if (la(r.status)) {
                  ...
                  return us(t, r, _a.card, n.locale, !1);
                }
                throw new Se(
      ...
      ms = function(e, t, n, r, o, i, a) {
        var s = yt(ca, o, "stripe.handleCardPayment intent secret"),
          c = s.value,
          u = _a.card,
          l = Ca(e, r, u, "handleCardPayment")(i, a),
          p = !i && !a;
        return t.action
          .confirmPaymentIntent(
            is({}, l, {
              otherParams: is({}, l.otherParams, { use_stripe_sdk: !0 }),
              intentSecret: c,
              expectedType: u,
              mids: n
            })
      ...
      ys = function(e, t, n, r, o, i) {
        var a = yt(ca, r, "stripe.handleSepaDebitPayment intent secret"),
          s = a.value,
          c = _a.sepa_debit,
          u = Ca(!0, n, c, "handleSepaDebitPayment")(o, i),
          l = !o && !i;
        return e.action
          .confirmPaymentIntent(
            is({}, u, { intentSecret: s, expectedType: c, mids: t })
          )
          .then(ls(e, c, l));
      },
      vs = function(e, t, n, r, o, i, a) {
        var s = yt(ca, o, "stripe.handleIdealPayment intent secret"),
          c = s.value,
          u = _a.ideal,
          l = Ca(e, r, u, "handleIdealPayment")(i, a),
          p = !i && !a;
        return t.action
          .confirmPaymentIntent(
            is({}, l, { intentSecret: c, expectedType: u, mids: n })
          )
          .then(ls(t, u, p));
      },
      bs = function(e, t, n, r, o, i) {
        var a = yt(ca, r, "stripe.handleFpxPayment intent secret"),
          s = a.value,
          c = _a.fpx,
          u = Ca(!1, n, c, "handleFpxPayment")(o, i),
          l = !o && !i;
        return e.action
          .confirmPaymentIntent(
            is({}, u, { intentSecret: s, expectedType: c, mids: t })
      ...
      Es = function(e, t, n, r, o) {
        var i = La(pa(t), n, e),
          a = sa(t);
        if (!i) return Te.resolve({ setupIntent: t });
        switch (i.type) {
          case "3ds1-modal":
            return Ba(i.url, a, Ct.SETUP_INTENT, e, r);
          case "3ds2-fingerprint":
          case "3ds2-challenge":
            return Ka(a, Ct.SETUP_INTENT, i, e, r, o);
          default:
            return Te.resolve({ setupIntent: t });
        }
      },
      ws = function(e, t, n, r, o) {
        return Es(e, t, n, r, o).then(function(e) {
          if (e.paymentIntent)
          ...
          switch (o.type) {
            case "error":
              ...
              return n && a && "succeeded" === a.status
                ? Te.resolve({ setupIntent: a })
                : Te.resolve({ error: i });
            case "object":
              var s = o.object;
              return ws(e, s, t, o.locale, r);
            default:
              return ke(o);
          }
        };
      ...
      Os = function(e, t, n, r, o) {
        var i = yt(ca, n, "stripe.handleCardSetup intent secret"),
          a = i.value,
          s = _a.card,
          c = Ca(!1, !1, s, "handleCardSetup")(r, o),
          u = !r && !o;
        return e.action
          .confirmSetupIntent(
            gs({}, c, {
              otherParams: gs({}, c.otherParams, { use_stripe_sdk: !0 }),
              intentSecret: a,
              expectedType: s,
              mids: t
            })
      ...
      As = function(e, t, n, r, o) {
        var i = yt(ca, n, "stripe.confirmSetupIntent intent secret"),
          a = i.value,
          s = Ca(!1, !1, null, "confirmSetupIntent")(r, o);
        return e.action
          .confirmSetupIntent(
            gs({}, s, {
              otherParams: gs({}, s.otherParams),
              intentSecret: a,
              expectedType: null,
              mids: t
            })
      ...
      Ts = function(e, t) {
        ...
        return t.action
          ...
          .then(ks(t, _a.card, !1, !0));
      },
      Is = [Mr.checkout_beta_2, Mr.checkout_beta_3, Mr.checkout_beta_4],
      Rs = [
        Mr.checkout_beta_2,
        Mr.checkout_beta_3,
        Mr.checkout_beta_4,
        Mr.checkout_pm_types
      ],
      Ns = {
        da: "da",
        de: "de",
      ...
      Ms = {
        ...
        locale: Ke($e.apply(void 0, ["auto"].concat(pe(Cs)))),
        customerEmail: Ke(tt),
      ...
      qs = function(e) {
        var t = ht(
            js({}, Ms, {
              items: Ke(
                Ve(
                  lt(ht({ type: $e("plan"), quantity: it(0), id: tt })),
                  lt(ht({ type: $e("sku"), quantity: it(0), id: tt }))
                )
              ),
              successUrl: tt,
              cancelUrl: tt
          ...
          c = Ls(o, i, a);
        return js({ tag: "no-session", items: c }, s);
      },
      Ds = function(e, t) {
        var n = ht(
            js({}, Ms, {
              ...
              items: Ke(
                Ve(
                  lt(ht({ quantity: it(0), plan: tt })),
                  lt(ht({ quantity: it(0), sku: tt }))
                )
              )
            })
          ),
        ...
        return js(
          { tag: "no-session", items: a, successUrl: s, cancelUrl: c },
          u
        );
      },
      xs = function(e, t) {
      ...
      Bs = function(e, t) {
        return "session" === t.tag ||
          null == e ||
          t.locale ||
          -1 === ["auto"].concat(pe(Cs)).indexOf(e)
          ? t
          : js({}, t, { locale: e });
      },
      Us = function(e, t, n) {
        var r = Ie(Is, function(t) {
          return qr(e, t);
        });
        switch ((Fs(r, e, t), r)) {
      ...
      Gs = function(e, t) {
        var n = function(t) {
          return Ja(e, "redirectToCheckout", t), { error: t.error };
        };
        return Va(t).then(n);
      },
      Ws = function(e, t, n, r) {
      ...
      Js = function(e) {
        return "object" === (void 0 === e ? "undefined" : Ks(e)) && null !== e
          ? e
          : {};
      },
      Qs = function(e, t, n) {
        ...
        if (r && "cardCvc" === r._componentName) {
          var o = r._frame.id;
          return e.action.tokenizeCvcUpdate({ frameId: o, mids: n }).then(Vs);
        }
        throw new Se(
      ...
      Zs = function(e, t) {
        return e.action.createRadarSession({ mids: t }).then(Xs);
      },
      ec =
        Object.assign ||
        function(e) {
      ...
      nc = _t({
        ...
        __checkout: Ke(_t({ mids: _t({ muid: tt, sid: tt }) })),
        __hosted3DS: Ke(rt),
      ...
      oc = (function() {
        function e(t, n) {
          var r = this;
          fe(this, e), ic.call(this);
          var o = yt(nc, t || {}, "Stripe()"),
            i = o.value,
            a = o.warnings,
            s = i.apiKey,
            c = i.stripeAccount,
          ...
          p && p.mids && (e._ec = new Oa({ checkoutIds: p.mids })),
            (this._apiKey = s),
            (this._keyMode = xe(s)),
            (this._locale = u || null),
            (this._betas = h || []),
          ...
          tc(e, [
            {
              ...
              value: function(e) {
                var t = this;
                e &&
                  (this.createRadarSession = rn(function() {
                    var e = t._mids();
                    return Zs(t._controller, e);
                  }));
              }
            },
            {
              ...
              value: function(e, t) {
                var n = this,
                  r =
                    qr(this._betas, Mr.payment_intent_beta_1) ||
                    qr(this._betas, Mr.payment_intent_beta_2),
                  o = function() {
                    return n._mids();
                  },
                  i = sn(function() {
                    for (
                      ...
                      t[r] = arguments[r];
                    return ps.apply(void 0, [n._controller, o()].concat(t));
                  }),
                  a = on(function(e) {
                  ...
                  s = sn(function() {
                    for (
                      ...
                      t[r] = arguments[r];
                    return fs.apply(void 0, [!0, n._controller, o()].concat(t));
                  }),
                  c = sn(function() {
                    for (
                      var e = arguments.length, t = Array(e), r = 0;
                      ...
                      t[r] = arguments[r];
                    return fs.apply(void 0, [!1, n._controller, o()].concat(t));
                  }),
                  u = Tn(ms, rc("handleCardPayment")),
                  l = sn(function() {
                    for (
                  ...
                  p = sn(function() {
                    ...
                    return u.apply(
                      void 0,
                      [!1, n._controller, o(), r].concat(t)
                    );
                  }),
                  d = Tn(_s, rc("handleCardAction")),
                  f = on(function(e) {
                    return d(e, n._controller);
                  }),
                  h = Tn(Os, rc("handleCardSetup")),
                  _ = sn(function() {
                    for (
                      var e = arguments.length, t = Array(e), r = 0;
                      r < e;
                  ...
                  v = sn(function() {
                    for (
                      ...
                      t[i] = arguments[i];
                    return ys.apply(void 0, [n._controller, o(), r].concat(t));
                  }),
                  b = sn(function() {
                    for (
                      var e = arguments.length, t = Array(e), i = 0;
                  ...
                  E = sn(function() {
                    for (
                      ...
                      t[i] = arguments[i];
                    return bs.apply(void 0, [n._controller, o(), r].concat(t));
                  }),
                  w = on(function(e) {
                    return hs(e, n._controller);
                  }),
                  S = on(function(e) {
                ...
                (this.createPaymentMethod = i),
                  ...
                  (this.handleCardPayment = p),
                  (this.confirmPaymentIntent = c),
                  (this.handleCardAction = f),
                  (this.handleFpxPayment = E),
                  (this.handleCardSetup = _),
                  (this.retrieveSetupIntent = m),
                  (this.confirmSetupIntent = y);
                var k = function(e) {
                  return function() {
                    throw new Se(
                ...
                (this.fulfillPaymentIntent = k("fulfillPaymentIntent")),
                  (this.handleSepaDebitPayment = k("handleSepaDebitPayment")),
                  (this.handleIdealPayment = k("handleIdealPayment")),
                  qr(this._betas, Mr.payment_intent_beta_1)
                    ? (this.fulfillPaymentIntent = l)
                    : (qr(this._betas, Mr.payment_intent_beta_3) ||
                        qr(this._betas, Mr.payment_intent_beta_2)) &&
                      (this.handleCardPayment = l),
                  qr(this._betas, Mr.payment_intent_beta_3) &&
                    ((this.confirmPaymentIntent = s),
                    (this.handleSepaDebitPayment = v),
                    (this.handleIdealPayment = b)),
                  qr(this._betas, Mr.ideal_pm_beta_1) &&
                    (this.handleIdealPayment = g),
                  t &&
                    ((this.handleHosted3DS2Payment = w),
                    (this.handleHosted3DS2Setup = S));
              }
            },
            {
              ...
              value: function(e) {
                var t = this;
                e &&
                  (this.tryNextAction = an(function(e, n) {
                    ...
                    return "payment_intent" === o.object
                      ? us(t._controller, o, s, "auto", !1)
                      : ws(t._controller, o, s, "auto", !1);
                  }));
              }
            },
            {
              ...
              value: function(e) {
                var t = this,
                  ...
                  r = e.reduce(function(e, t) {
                    var n = Ie(Rs, function(e) {
                      return e === t;
                    });
                    return n ? [].concat(he(e), [n]) : e;
                  }, []);
                this.redirectToCheckout = Ws(
                  this._controller,
                  r,
                  n,
                  this._locale
            ...
            },
            {
              ...
              value: function() {
                ...
                if (
                  ur &&
                  !e &&
                  !qr(this._betas, Mr.acknowledge_ie9_deprecation)
                )
                  throw (window.console && console.error(t), new Se(t));
              }
            },
            {
              key: "_ensureHTTPS",
    ...
    (oc.version = 3),
      (oc.stripeJsId = Ht()),
      (oc._ec = (function() {
        return "https://localhost:122112/".match(
    ...
    var ic = function() {
        ...
        (this.elements = on(function(t) {
          return new ea(
            e._controller,
            ec({}, e._locale ? { locale: e._locale } : {}, t, {
              betas: e._betas
            })
          );
        })),
          (this.createToken = an(function(t, n) {
            var r = e._mids();
            if ("cvc_update" === t) {
              if (qr(e._betas, Mr.cvc_update_beta_1))
                return Qs(e._controller, n, r);
              throw new Se(
                "You cannot create a 'cvc_update' token without using the 'cvc_update_beta_1' beta flag."
              );
            }
            return $s(e._controller, r)(t, n);
          })),
            ...
            return o
              ? a
                ? e._controller.action
                    ...
                    .then(ts)
                : Te.reject(
                    new Se("Please provide a source type to createSource.")
                  )
              : Te.reject(
                  new Se(
          ...
          (this.retrieveSource = on(function(t) {
            var n = yt(rs, { source: t }, "retrieveSource"),
              r = n.value;
            return (
              n.warnings.forEach(function(t) {
                return e._controller.warn(t);
              }),
              e._controller.action.retrieveSource(r).then(ts)
            );
          })),
      ...
      lc = function(e, t) {
        return new ac(
          cc(
            { apiKey: e },
            t && "object" === (void 0 === t ? "undefined" : sc(t)) ? t : {}
          ),
          uc
        );
      };
    (lc.version = ac.version),
      window.Stripe && 2 === window.Stripe.version && !window.Stripe.StripeV3
        ? (window.Stripe.StripeV3 = lc)
        : window.Stripe
        ? window.console &&
          console.warn(
